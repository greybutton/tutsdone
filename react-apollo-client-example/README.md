[https://www.robinwieruch.de/react-apollo-client-example/](https://www.robinwieruch.de/react-apollo-client-example/)

A minimal Apollo Client in React Example with GitHub api v4.
