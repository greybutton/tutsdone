A apollo-link-state Tutorial for Local State in React [https://www.robinwieruch.de/react-apollo-link-state-tutorial/](https://www.robinwieruch.de/react-apollo-link-state-tutorial/)
